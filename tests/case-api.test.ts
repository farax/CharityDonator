  ...
  describe("GET /api/cases", () => {
    it("should return all cases", async () => {
      ...
      const caseData: InsertCase = {
        ...
        description:
          "This is an API test case for testing the get all cases endpoint functionality.",
  ...
  describe("GET /api/cases/:id", () => {
    beforeEach(async () => {
      const caseData: InsertCase = {
        ...
        description:
          "This is an API test case for testing the get single case endpoint functionality.",
    ...
    it("should return 404 for non-existent case", async () => {
      const response = await request(app).get("/api/cases/99999").expect(404);

      expect(response.body.message).toBe("Case not found");
    });

    it("should return 404 for invalid case ID", async () => {
      await request(app).get("/api/cases/invalid-id").expect(404);
    });
  });
  ...
  describe("POST /api/cases", () => {
    it("should create a new case with valid data", async () => {
      const caseData: InsertCase = {
        ...
        description:
          "This is an API test case for testing the create case endpoint functionality.",
    ...
    it("should create case with minimal valid data", async () => {
      const caseData: InsertCase = {
        ...
        description:
          "This is an API test case with minimal data for testing endpoint functionality.",
  ...
  describe("PUT /api/cases/:id", () => {
    beforeEach(async () => {
      const caseData: InsertCase = {
        ...
        description:
          "This is an API test case for testing the update case endpoint functionality.",
    ...
    it("should update case with complete data", async () => {
      const updateData: Partial<InsertCase> = {
        ...
        description:
          "This case has been completely updated through the API for testing purposes.",
  ...
  describe("DELETE /api/cases/:id", () => {
    beforeEach(async () => {
      const caseData: InsertCase = {
        ...
        description:
          "This is an API test case for testing the delete case endpoint functionality.",
    ...
    it("should delete an existing case", async () => {
      ...
      await request(app).get(`/api/cases/${testCase.id}`).expect(404);
  ...
  describe("PATCH /api/cases/:id/toggle-status", () => {
    beforeEach(async () => {
      const caseData: InsertCase = {
        ...
        description:
          "This is an API test case for testing the toggle status endpoint functionality.",
  ...
  describe("PATCH /api/cases/:id/amount-collected", () => {
    beforeEach(async () => {
      const caseData: InsertCase = {
        ...
        description:
          "This is an API test case for testing the amount update endpoint functionality.",
    ...
    it("should return 400 for invalid amount", async () => {
      ...
      expect(response.body.message).toBe(
        "Additional amount must be a positive number",
      );
    });
  ...
  describe("Integration Tests", () => {
    it("should handle complete case lifecycle", async () => {
      ...
      const caseData: InsertCase = {
        ...
        description:
          "This is an API test case for testing the complete case lifecycle functionality.",
      ...
      // Verify in list
      response = await request(app).get("/api/cases").expect(200);
      ...
      // Delete case
      await request(app).delete(`/api/cases/${testCase.id}`).expect(200);
